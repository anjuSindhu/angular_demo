...
@Component({
  selector: 'app-jqx-pivotgrid',
  templateUrl: './jqx-pivotgrid.component.html',
  styleUrls: ['./jqx-pivotgrid.component.scss']
})
export class JqxPivotgridComponent {
  
    @ViewChild(jqxPivotGridComponent) pivotGrid: jqxPivotGridComponent; 
    @ViewChild(jqxPivotDesignerComponent) pivotDesigner: jqxPivotDesignerComponent; 
